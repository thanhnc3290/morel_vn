    ...
    <div class="content-wrapper">
      <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
              <h3 class="content-header-title mb-0">Quản lý Dự Án</h3>
          </div>
          <div class="content-header-right col-md-6 col-12">
              <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                  <a href="<?php echo admin_url('project/add') ?>">
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            <?php 
                              $image_of_this_info = '';
                                if($row->image_link !== ''){
                                  $image_of_this_info = base_url('upload/project/'.$row->image_link);
                                }
                              ?>
                          ...
                          <td>
                            <a href="<?php echo admin_url('project/edit/'.$row->id); ?>" title="chỉnh sửa"><i class="ft-edit"></i></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo admin_url('project/delete/'.$row->id) ?>"><button type="button" class="btn btn-primary">Xóa</button></a>
          </div>
        </div>
      </div>
    </div>
