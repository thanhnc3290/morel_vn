<div class="app-content content">
    <div class="content-wrapper">
		<div class="content-header row">
			...
			<h3 class="content-header-title mb-0">Tạo mới Dự Án</h3>
			</div>
		</div>
		                  	...
		                  	<div class="card-body">
			                    ...
			                    <form class="form" action="" method="post" enctype="multipart/form-data">
			                      	<div class="row justify-content-md-left">
				                        ...
				                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input onchange="create_alias()" id="input_name" type="text" class="form-control" id="basicInput" name="name" placeholder="Nhập tên Dự Án" required>
                                            </fieldset> 
                                        </div>
                                    ...
                                    <div class="row justify-content-md-left">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                                            <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                                <h4><u><b>Hình ảnh kèm theo:</b></u></h4>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <fieldset class="form-group">
