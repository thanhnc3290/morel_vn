<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/vendors/css/forms/selects/select2.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/vendors/css/extensions/unslider.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/vendors/css/weather-icons/climacons.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/fonts/meteocons/style.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/vendors/css/charts/morris.css">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/fonts/simple-line-icons/style.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/css/core/colors/palette-gradient.css">
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/css/pages/timeline.css">
  <!-- END Page Level CSS-->
  <link rel="stylesheet" type="text/css" href="<?php echo public_url() ?>admin/app-assets/vendors/css/tables/datatable/datatables.min.css">
  <!-- BEGIN Custom CSS-->
