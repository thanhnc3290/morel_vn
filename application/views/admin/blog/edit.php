<div class="app-content content">
    <div class="content-wrapper">
		<div class="content-header row">
			...
			<h3 class="content-header-title mb-0">Chỉnh Sửa Bài Viết</h3>
			</div>
		</div>
			                      	...
			                      	<div class="row justify-content-md-left">
				                        ...
				                        <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input onchange="create_alias_<?php echo $info->id ?>()" id="input_name_<?php echo $info->id ?>" type="text" class="form-control" id="basicInput" name="name" placeholder="Nhập tên bài viết" value="<?php echo $info->name ?>">
                                            </fieldset> 
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                ...
                                                <?php 
                                                    ...
                                                    if($info->image_link !== ''){
                                                        $image_link_of_this_info = base_url('upload/news/'.$info->image_link);
                                                    }
                                                ?>
                                                <fieldset class="form-group">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                ...
                                                <?php 
                                                    ...
                                                    if($info->social_image_link !== ''){
                                                        $social_image_link_of_this_info = base_url('upload/news/'.$info->social_image_link);
                                                    }
                                                ?>
                                                <fieldset class="form-group">
