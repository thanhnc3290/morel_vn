    ...
    <div class="content-wrapper">
      <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
              <h3 class="content-header-title mb-0">Quản lý Slider Bác sĩ</h3>
          </div>
          <div class="content-header-right col-md-6 col-12">
              <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                  <a href="" data-toggle="modal" data-target="#edit_total_link" style="margin-right: 10px;">
                      <div class="btn-group" role="group">
                          <button class="btn btn-outline-primary" type="button"><i class="ft-plus-square icon-left"></i> Chỉnh sửa link xem thêm của vùng</button>
                      </div>
                  </a>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            <?php 
                              $image_of_this_info = '';
                              if($row->image_link !== ''){
                                $image_of_this_info = base_url('upload/doctor_slider/'.$row->image_link);
                              }
                            ?>
  ...
  <div class="modal fade" id="create" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        ...
        <!-- form create -->
        <form class="form" action="<?php echo admin_url('doctor_slider/create_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Chức danh:</label>
                    <input id="input_name" type="text" class="form-control" id="basicInput" name="position" placeholder="Nhập Chức danh" required>
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                  <fieldset class="form-group">
                    ...
                    <textarea id="editor" type="text" class="form-control" id="basicInput" name="content" rows="3" placeholder="Nhập nội dung tối đa 255 ký tự"></textarea>
              ...
              <div class="row justify-content-md-left" >
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                    <h4><u><b>Hình ảnh Bác sĩ:</b><br/><em>(kích thước 350x370px):</em></u></h4>
                  </div>
                ...
                <!-- <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                    <h4><u><b>Hình ảnh Background (không bắt buộc):</b><br/><em>(kích thước 962x505px):</em></u></h4>
                  </div>
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    <fieldset class="form-group">
                      <input name="background_image_link" type="file" id="files_bg">
                    </fieldset>
                    <fieldset class="form-group">
                      <center><img id="image_bg" style="max-height:300px;max-width:100%;background:#000000;" src="" /></center>
                      <script>
                        document.getElementById("files_bg").onchange = function () {
                          var reader = new FileReader();
                          reader.onload = function (e) {
                            // get loaded data and render thumbnail.
                            document.getElementById("image_bg").src = e.target.result;
                          };
                          // read the image file as a data URL.
                          reader.readAsDataURL(this.files[0]);
                        };
  ...
  <div class="modal fade" id="edit_id_<?php echo $row->id ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        ...
        <!-- form edit -->
        <form class="form" action="<?php echo admin_url('doctor_slider/edit_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    ...
                    <input id="" type="text" class="form-control" id="basicInput" name="name" placeholder="Nhập tên slider" value="<?php echo $row->name ?>" required>
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Chức danh:</label>
                    <input id="" type="text" class="form-control" id="basicInput" name="position" placeholder="Nhập Chức danh" value="<?php echo $row->position ?>" required>
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Nội dung:</label>
                    <textarea id="editor_<?php echo $row->id ?>" type="text" class="form-control" id="basicInput" name="content" rows="3" placeholder="Nhập nội dung tối đa 255 ký tự"><?php echo $row->content ?></textarea>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Thứ tự ưu tiên:</label>
                    <input type="number" class="form-control" id="basicInput" name="sort_order" value="<?php echo $row->content ?>">
                  </fieldset>
                </div>
              ...
              <div class="row justify-content-md-left" >
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <!-- Thẻ hiển thị Preview ảnh -->
                    <fieldset class="form-group">
                      <center><img id="image_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo base_url('upload/doctor_slider/'.$row->image_link) ?>" /></center>
                      <script>
                ...
                <!-- <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  ...
                  <?php 
                    ...
                    if($row->background_image_link !== ''){
                      $background_image_link = base_url('upload/doctor_slider/'.$row->background_image_link);
                    }
                  ?>
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    <fieldset class="form-group">
                      <input name="background_image_link" type="file" id="files_bg_<?php echo $row->id ?>">
                    </fieldset>
                    <fieldset class="form-group">
                      <center><img id="image_bg_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo $background_image_link ?>" /></center>
                      <script>
                        document.getElementById("files_bg_<?php echo $row->id ?>").onchange = function () {
                          var reader = new FileReader();
                          reader.onload = function (e) {
                            // get loaded data and render thumbnail.
                            document.getElementById("image_bg_<?php echo $row->id ?>").src = e.target.result;
                          };
                          // read the image file as a data URL.
                          reader.readAsDataURL(this.files[0]);
                        };
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo admin_url('doctor_slider/delete/'.$row->id) ?>"><button type="button" class="btn btn-primary">Xóa</button></a>
          </div>
        </div>
      </div>
    </div>
