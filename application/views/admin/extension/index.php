    ...
    <div class="content-wrapper">
      <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
              <h3 class="content-header-title mb-0">Quản lý Nút tiện ích</h3>
          </div>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            <?php 
                              $image_of_this_info = '';
                              if($row->image_link !== ''){
                                $image_of_this_info = base_url('upload/extension/'.$row->image_link);
                              }  
                          ...
                          <td>
                            <?php echo $row->name ?>
                            <br/>- Trạng thái: <?php if($row->status == '0'): ?><span style="color:green;">Hiển thị</span><?php else: ?><span style="color:red;">Không hiển thị</span><?php endif; ?>
    ...
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><b>Tạo mới Nút tiện ích</b></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <!-- form create -->
        <form class="form" action="<?php echo admin_url('extension/create_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Màu nền:</label>
                    <input id="" type="color" class="form-control" id="basicInput" name="background_color" placeholder="Nhập màu nền">
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                  <fieldset class="form-group">
                    ...
                    <textarea id="" type="text" class="form-control" id="basicInput" name="content" rows="3" placeholder="Nhập Nội dung" required></textarea>
                  </fieldset> 
                </div>
              ...
              <div class="row justify-content-md-left" >
                  <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                    <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                      <h4><u><b>Hình ảnh Icon:</b> <br/><em>(kích thước: 70x70px - PNG nền trong)</em></u></h4>
                    </div>
...
<!---------------------------------------------------------------------------------------------------------------------------------- Modal edit -->
  ...
  <div class="modal fade" id="edit_id_<?php echo $row->id ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><b>Chỉnh sửa Nút tiện ích: "<?php echo $row->name ?>"</b></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <!-- form edit -->
        <form class="form" action="<?php echo admin_url('extension/edit_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Màu nền:</label>
                    <input id="" type="color" class="form-control" id="basicInput" name="background_color" placeholder="Nhập màu nền" value="<?php echo $row->background_color ?>">
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Nội dung:</label>
                    <textarea id="" type="text" class="form-control" id="basicInput" name="content" rows="3" placeholder="Nhập Nội dung"><?php echo $row->content ?></textarea>
                  </fieldset> 
                </div>
              ...
              <div class="row justify-content-md-left" >
                  <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      ...
                      <!-- Thẻ hiển thị Preview ảnh -->
                      <fieldset class="form-group">
                        <center><img id="image_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo base_url('upload/extension/'.$row->image_link) ?>" /></center>
                        <script>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo admin_url('extension/delete/'.$row->id) ?>"><button type="button" class="btn btn-primary">Xóa</button></a>
          </div>
        </div>
      </div>
    </div>
