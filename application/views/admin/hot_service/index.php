            ...
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <fieldset class="form-group">
                    <label for="basicTextarea">Đoạn Mô Tả Ngắn:</label>
                    <textarea name="meta_desc" class="form-control" id="basicTextarea" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 200px;" placeholder="Nhập đoạn mô tả ngắn"></textarea>
                  </fieldset>
                </div>
              ...
              <div class="row justify-content-md-left" >
                  <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                    <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                      <h4><u><b>Hình ảnh:</b> <br/><em>(kích thước: 400x400px)</em></u></h4>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      <fieldset class="form-group">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                    <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                      <h4><u><b>Hình ảnh nhỏ:</b> <br/><em>(kích thước: 160x160px)</em></u></h4>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      <fieldset class="form-group">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    <label for="basicInput">Tiêu đề:</label>
                    <input id="" type="text" class="form-control" id="basicInput" name="title" placeholder="Nhập tiêu đề" value="<?php echo $row->title ?>" required>
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <fieldset class="form-group">
                    <label for="basicTextarea">Đoạn Mô Tả Ngắn:</label>
                    <textarea name="meta_desc" class="form-control" id="basicTextarea" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 200px;" placeholder="Nhập đoạn mô tả ngắn"><?php echo $row->meta_desc ?></textarea>
                  </fieldset>
                </div>
              ...
              <div class="row justify-content-md-left" >
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                      <fieldset class="form-group">
                        <input name="thumb_image_link" type="file" id="thumb_files_<?php echo $row->id ?>">
                      </fieldset>
                      <!-- Thẻ hiển thị Preview ảnh -->
                      <fieldset class="form-group">
                        <center><img id="thumb_image_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo base_url('upload/hot_service/'.$row->thumb_image_link) ?>" /></center>
                        <script>
                          document.getElementById("thumb_files_<?php echo $row->id ?>").onchange = function () {
                            var reader = new FileReader();
                            reader.onload = function (e) {
                              // get loaded data and render thumbnail.
                              document.getElementById("thumb_image_<?php echo $row->id ?>").src = e.target.result;
                            };
                            // read the image file as a data URL.
                            reader.readAsDataURL(this.files[0]);
                          };
