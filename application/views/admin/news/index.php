    ...
    <div class="content-wrapper">
      <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
              <h3 class="content-header-title mb-0">Quản lý Bài viết</h3>
          </div>
          <div class="content-header-right col-md-6 col-12">
              <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                  <!-- <a href="" data-toggle="modal" data-target="#edit_slider_news" style="margin-right: 10px;">
                      <div class="btn-group" role="group">
                          <button class="btn btn-outline-primary" type="button"><i class="ft-plus-square icon-left"></i> Chỉnh sửa Slider Tin tức</button>
                      </div>
                  </a> -->
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            <?php 
                              $image_of_this_info = '';
                                if($row->image_link !== ''){
                                  $image_of_this_info = base_url('upload/news/'.$row->image_link);
                                }
                              ?>
                          ...
                          <td><?php echo $row->name ?>
                            <br/>- Loại hình: <?php if($row->video_link !== ''): ?>Bài viết có Video<?php else: ?>Bài viết thông thường<?php endif; ?>
                              ...
                              <?php 
                                ...
                                // if(($catalog_video_id !== '0') && ($row->video_link !== '')){
                                //   $catalog_video_info = $this->catalog_model->get_info($catalog_video_id);
                                //   $position_video = $catalog_video_info->name;
                                // }

                              ?>
                              <br/>- Danh mục: <?php echo $position; ?>
                              <!-- <?php if($position_video !== ''): ?>
                              <br/>- Danh mục Video: <?php echo $position_video; ?>
                              <?php endif; ?> -->
...
<!---------------------------------------------------------------------------------------------------------------------------------- Modal edit total link -->
  <div class="modal fade" id="edit_slider_news" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        ...
        <form class="form" action="<?php echo admin_url('news/edit_slider_news_modal') ?>" method="post" enctype="multipart/form-data">
           <div class="modal-body">
            <div class="card-body">
              <div class="row justify-content-md-left">
                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                  <fieldset class="form-group">
                    <p><em>*: Lựa chọn danh mục nào thì sẽ hiển thị các nội dung trực thuộc danh mục đó dưới dạng slider ở phần cuối trang chủ</em></p>
                    <label for="basicInput">Lựa chọn danh mục được hiển thị:</label>
                    <select class="form-control" id="basicSelect" name="slider_news_catalog_id" required>
                      <option value=""> --- Lựa chọn danh mục --- </option>
                      <?php foreach($catalog_list as $row): ?>
                        <option value="<?php echo $row->id ?>" <?php if($row->status !== '0') echo 'disabled' ?> <?php if($row->id == $site_info->slider_news_catalog_id) echo 'selected' ?>><strong><?php echo $row->name ?></strong></option>
                        <?php foreach($row->subs as $subs): ?>
                          <option value="<?php echo $subs->id ?>" <?php if($subs->status !== '0') echo 'disabled' ?> <?php if($subs->id == $site_info->slider_news_catalog_id) echo 'selected' ?>>-- <i><?php echo $subs->name ?></i></option>
                          <?php foreach($subs->subss as $subss): ?>
                            <option value="<?php echo $subss->id ?>" <?php if($subss->status !== '0') echo 'disabled' ?> <?php if($subss->id == $site_info->slider_news_catalog_id) echo 'selected' ?>>-- -- <i><?php echo $subss->name ?></i></option>
                          <?php endforeach; ?>
                        <?php endforeach; ?>
                      <?php endforeach; ?>
                    </select>
...
<!---------------------------------------------------------------------------------------------------------------------------------- Modal create -->
  <div class="modal fade" id="create" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><b>Tạo mới Bài viết</b></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <!-- form create -->
        <form class="form" action="<?php echo admin_url('news/create_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                  <fieldset class="form-group">
                    ...
                    <select class="form-control" id="basicSelect" name="catalog_id" required>
                      <option value=""> --- Lựa chọn danh mục --- </option>
                      <?php foreach($catalog_list as $row): ?>
                        <option value="<?php echo $row->id ?>" <?php if(count($row->subs) > '0') {echo 'disabled';} ?> <?php if($row->status !== '0') { echo 'disabled';}else{ if($row->url_status !== '0'){ echo 'disabled'; }else{ if($row->content_status !== '0'){ echo 'disabled';}else{if($row->layout_type == '999'){ echo 'disabled';}}}}?>><strong><?php echo $row->name ?><?php if($row->status !== '0') { echo '(disabled)';}else{ if($row->url_status !== '0'){ echo '(disabled)'; }else{ if($row->content_status !== '0'){ echo '(disabled)';}else{if($row->layout_type == '999'){ echo '(disabled)';}}}}?></strong></option>
                        <?php foreach($row->subs as $subs): ?>
                          <option value="<?php echo $subs->id ?>" <?php if(count($subs->subss) > '0') {echo 'disabled';} ?> <?php if($subs->status !== '0') { echo 'disabled';}else{ if($subs->url_status !== '0'){ echo 'disabled'; }else{ if($subs->content_status !== '0'){ echo 'disabled';}else{if($subs->layout_type == '999'){ echo 'disabled';}}}}?>>-- <i><?php echo $subs->name ?><?php if($subs->status !== '0') { echo '(disabled)';}else{ if($subs->url_status !== '0'){ echo '(disabled)'; }else{ if($subs->content_status !== '0'){ echo '(disabled)';}else{if($subs->layout_type == '999'){ echo '(disabled)';}}}}?></i></option>
                          <?php foreach($subs->subss as $subss): ?>
                            <option value="<?php echo $subss->id ?>" <?php if($subss->status !== '0') { echo 'disabled';}else{ if($subss->url_status !== '0'){ echo 'disabled'; }else{ if($subss->content_status !== '0'){ echo 'disabled';}else{if($subss->layout_type == '999'){ echo 'disabled';}}}}?>>-- -- <i><?php echo $subss->name ?><?php if($subss->status !== '0') { echo '(disabled)';}else{ if($subss->url_status !== '0'){ echo '(disabled)'; }else{ if($subss->content_status !== '0'){ echo '(disabled)';}else{if($subss->layout_type == '999'){ echo '(disabled)';}}}}?></i></option>
                          <?php endforeach; ?>
                        <?php endforeach; ?>
                      <?php endforeach; ?>
                    </select>
              ...
              <div class="row justify-content-md-left" id="content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <fieldset class="form-group">
                    <textarea name="content" id="editor_0" class="form-control" rows="6" style="margin-top: 0px; margin-bottom: 0px; height: 75px;"></textarea>
                    <script>
...
<!---------------------------------------------------------------------------------------------------------------------------------- Modal edit -->
  ...
  <div class="modal fade" id="edit_id_<?php echo $row->id ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width:98%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><b>Chỉnh sửa bài viết: "<?php echo $row->name ?>"</b></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <!-- form edit -->
        <form class="form" action="<?php echo admin_url('news/edit_modal') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="card-body">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  <fieldset class="form-group">
                    ...
                    <input onchange="create_alias_<?php echo $row->id ?>()" id="input_name_<?php echo $row->id ?>" type="text" class="form-control" id="basicInput" name="name" placeholder="Nhập tên slider" value="<?php echo $row->name ?>">
                  </fieldset> 
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
                  <fieldset class="form-group">
                    <label for="basicSelect">Danh mục:</label>
                    <select class="form-control" id="basicSelect" name="catalog_id">
                      <?php foreach($catalog_list as $cat): ?>
                        <option value="<?php echo $cat->id ?>" <?php if(count($cat->subs) > '0') {echo 'disabled';} ?> <?php if($cat->status !== '0') { echo 'disabled';}else{ if($cat->url_status !== '0'){ echo 'disabled'; }else{ if($cat->content_status !== '0'){ echo 'disabled';}else{if($cat->layout_type == '999'){ echo 'disabled';}}}}?> <?php if($row->catalog_id == $cat->id) echo 'selected' ?>><strong><?php echo $cat->name ?></strong></option>
                        <?php foreach($cat->subs as $subs): ?>
                          <option value="<?php echo $subs->id ?>" <?php if(count($subs->subss) > '0') {echo 'disabled';} ?> <?php if($subs->status !== '0') { echo 'disabled';}else{ if($subs->url_status !== '0'){ echo 'disabled'; }else{ if($subs->content_status !== '0'){ echo 'disabled';}else{if($subs->layout_type == '999'){ echo 'disabled';}}}}?> <?php if($row->catalog_id == $subs->id) echo 'selected' ?>>-- <i><?php echo $subs->name ?></i></option>
                          <?php foreach($subs->subss as $subss): ?>
                            <option value="<?php echo $subss->id ?>" <?php if($subss->status !== '0') { echo 'disabled';}else{ if($subss->url_status !== '0'){ echo 'disabled'; }else{ if($subss->content_status !== '0'){ echo 'disabled';}else{if($subss->layout_type == '999'){ echo 'disabled';}}}}?> <?php if($row->catalog_id == $subss->id) echo 'selected' ?>>-- -- <i><?php echo $subss->name ?></i></option>
                          <?php endforeach; ?>
                        <?php endforeach; ?>
                      <?php endforeach; ?>
                    </select>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                  <fieldset class="form-group">
                    <label for="basicTextarea">Mô tả (Meta Descreption):</label>
                    <textarea name="meta_desc" class="form-control" id="basicTextarea" rows="3" placeholder="Nhập mô tả" required><?php echo $row->meta_desc ?></textarea>
                  </fieldset>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                  <fieldset class="form-group">
                    <label for="basicTextarea">Từ khóa (Meta Keywords):</label>
                    <textarea name="meta_key" class="form-control" id="basicTextarea" rows="3" placeholder="Nhập từ khóa" required><?php echo $row->meta_key ?></textarea>
                  </fieldset>
                </div>
              ...
              <div class="row justify-content-md-left">
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <!-- Thẻ hiển thị Preview ảnh -->
                    <fieldset class="form-group">
                      <center><img id="image_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo base_url('upload/news/'.$row->image_link) ?>" /></center>
                      <script>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-1">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12">
                    <fieldset class="form-group">
                      <input name="social_image_link" type="file" id="files_social_<?php echo $row->id ?>">
                    </fieldset>
                    <!-- Thẻ hiển thị Preview ảnh -->
                    <fieldset class="form-group">
                      <center><img id="image_social_<?php echo $row->id ?>" style="max-height:300px;max-width:100%;background:#000000;" src="<?php echo base_url('upload/news/'.$row->social_image_link) ?>" /></center>
                      <script>
                        document.getElementById("files_social_<?php echo $row->id ?>").onchange = function () {
                          var reader = new FileReader();
                          reader.onload = function (e) {
                            // get loaded data and render thumbnail.
                            document.getElementById("image_social_<?php echo $row->id ?>").src = e.target.result;
                          };
                          // read the image file as a data URL.
                          reader.readAsDataURL(this.files[0]);
                        };
              ...
              <div class="row justify-content-md-left" id="content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  <fieldset class="form-group">
                    <textarea name="content" id="editor_<?php echo $row->id ?>" class="form-control" rows="6" style="margin-top: 0px; margin-bottom: 0px; height: 75px;"><?php echo $row->content ?></textarea>
                    <script>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo admin_url('news/delete/'.$row->id) ?>"><button type="button" class="btn btn-primary">Xóa</button></a>
          </div>
        </div>
      </div>
    </div>
