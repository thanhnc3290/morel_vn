<div class="app-content content">
    <div class="content-wrapper">
		<div class="content-header row">
			...
			<h3 class="content-header-title mb-0">Tạo mới Công Nghệ Sản Phẩm</h3>
			</div>
		</div>
			                      	...
			                      	<div class="row justify-content-md-left">
				                        ...
				                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input id="input_name" type="text" class="form-control" id="basicInput" name="name" placeholder="Nhập tên công nghệ" required>
                                            </fieldset> 
                                        </div>
